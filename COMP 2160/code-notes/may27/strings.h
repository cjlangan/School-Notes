...
// Caller must destroy string by passing this instance to destroy_string.
 ...
 *
 * Args:
 *  s: the contents of s will not be changed
 *  index: tha chracter at that index, or the NULL byte if invalid index
 */
