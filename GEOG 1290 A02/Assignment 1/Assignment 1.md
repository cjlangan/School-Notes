...
- 600-800 words, double-spaced, no title page
...
-   [Getting Started on Assignment 1](https://universityofmanitoba.desire2learn.com/d2l/le/content/556805/viewContent/3699509/View)
...
## Theme: Anthropogenic Landscape
Use a [Google Earth](https://www.google.com/earth/about/) Screenshot that visibly shows a human influenced/modified  (anthropogenic landscape). Chose from the following:
1. Banaue Rice Terraces, Philippines
2. Diamond Mines, NWT Canada
3. Nile Delta, Egypt
4. Panama Canal
5. Three Gorges Dam, China
6. Lithium fields, Salar de Atacama salt flats Northern Chile
7. Winnipeg Floodway
